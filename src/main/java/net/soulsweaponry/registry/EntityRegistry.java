...
public class EntityRegistry {
    ...
    public static final EntityType<BlackflameExplosionEntity> BLACKFLAME_EXPLOSION_ENTITY = Registry.register(Registries.ENTITY_TYPE, new Identifier(ModId, "blackflame_explosion_entity"), FabricEntityTypeBuilder.create(SpawnGroup.MISC, BlackflameExplosionEntity::new).dimensions(EntityDimensions.fixed(2f, 2f)).fireImmune().trackRangeChunks(4).trackedUpdateRate(Integer.MAX_VALUE).build());
