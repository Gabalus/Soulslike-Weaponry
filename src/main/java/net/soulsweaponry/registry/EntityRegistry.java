...
public class EntityRegistry {
    ...
    public static final EntityType<MoonveilWave> MOONVEIL_WAVE = Registry.register(Registries.ENTITY_TYPE, new Identifier(ModId, "moonveil_wave"), FabricEntityTypeBuilder.<MoonveilWave>create(SpawnGroup.MISC, MoonveilWave::new).dimensions(EntityDimensions.fixed(4.5f, 0.5f)).trackRangeChunks(4).trackedUpdateRate(20).build());
    public static final EntityType<MoonveilHorizontal> MOONVEIL_HORIZONTAL = registerEntity("moonveil_horizontal", FabricEntityTypeBuilder.<MoonveilHorizontal>create(SpawnGroup.MISC, MoonveilHorizontal::new).dimensions(EntityDimensions.changing(1.85f, 1.85f)).fireImmune().trackRangeChunks(4).trackedUpdateRate(Integer.MAX_VALUE).build());
