...
public class EntityRegistry {
    ...
    public static final EntityType<BigChungus> BIG_CHUNGUS = Registry.register(Registries.ENTITY_TYPE, new Identifier(ModId, "big_chungus"), FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, BigChungus::new).dimensions(EntityDimensions.fixed(0.75f, 1f)).build());
    ...
    public static final EntityType<MoonlightProjectile> DARK_MOON_PROJECTILE = Registry.register(Registries.ENTITY_TYPE, new Identifier(ModId, "dark_moon_projectile"), FabricEntityTypeBuilder.<MoonlightProjectile>create(SpawnGroup.MISC, MoonlightProjectile::new).dimensions(EntityDimensions.fixed(2F, 1F)).trackRangeChunks(4).trackedUpdateRate(20).build());
    ...
    public static final EntityType<GhostGlaiveEntity> GHOST_GLAIVE_TYPE = Registry.register(Registries.ENTITY_TYPE, new Identifier(ModId, "ghost_glaive"), FabricEntityTypeBuilder.<GhostGlaiveEntity>create(SpawnGroup.MISC, GhostGlaiveEntity::new).dimensions(EntityDimensions.fixed(1F, 1F)).trackRangeChunks(4).trackedUpdateRate(20).build());
    public static final EntityType<MoonveilWave> MOONVEIL_HORIZONTAL = Registry.register(Registries.ENTITY_TYPE, new Identifier(ModId, "moonveil_horizontal"), FabricEntityTypeBuilder.<MoonveilWave>create(SpawnGroup.MISC, MoonveilWave::new).dimensions(EntityDimensions.fixed(4.5f, 0.5f)).trackRangeChunks(4).trackedUpdateRate(20).build());
    public static final EntityType<MoonveilWave> MOONVEIL_VERTICAL = Registry.register(Registries.ENTITY_TYPE, new Identifier(ModId, "moonveil_vertical"), FabricEntityTypeBuilder.<MoonveilWave>create(SpawnGroup.MISC, MoonveilWave::new).dimensions(EntityDimensions.fixed(0.5f, 3.0f)).trackRangeChunks(4).trackedUpdateRate(20).build());
    public static final EntityType<BlackflameExplosionEntity> BLACKFLAME_EXPLOSION_ENTITY = Registry.register(Registries.ENTITY_TYPE, new Identifier(ModId, "blackflame_explosion_entity"), FabricEntityTypeBuilder.<BlackflameExplosionEntity>create(SpawnGroup.MISC, BlackflameExplosionEntity::new).dimensions(EntityDimensions.fixed(2f, 2f)).fireImmune().trackRangeChunks(4).trackedUpdateRate(Integer.MAX_VALUE).build());
